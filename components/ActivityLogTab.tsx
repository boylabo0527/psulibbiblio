...
const ACTION_LABEL: Record<string, string> = {
  ...
  assignment_bulk_remove: "Titles bulk-removed from course",
  assignment_lock: "Title match locked",
  assignment_unlock: "Title match unlocked",
  ...
  tor_generate: "Terms of Reference generated",
};
